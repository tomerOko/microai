...
k8s_yaml("k8s/sockets-d.yaml")
docker_build("sockets", "services/sockets", live_update=[sync("services/sockets/src", "/app/src")])
k8s_resource('sockets-d', port_forwards=['3013:3000','9013:9229'])