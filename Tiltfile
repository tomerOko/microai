...
k8s_yaml("k8s/notifications-d.yaml")
docker_build("notifications", "services/notifications", live_update=[sync("services/notifications/src", "/app/src")])
k8s_resource('notifications-d', port_forwards=['3008:3000','9008:9229'])
...
k8s_yaml("k8s/sokcets-d.yaml")
docker_build("sokcets", "services/sokcets", live_update=[sync("services/sokcets/src", "/app/src")])
k8s_resource('sokcets-d', port_forwards=['3013:3000','9013:9229'])